      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-20">
        <div className="px-10 flex flex-col gap-7 justify-center">
          ...
          <p className="text-sm">
            ...
            the best doctors and nurses to take care of you. We are open 24/7 to
            take care of you. We are here to serve you. We provide the best
            medical services for all our patients. We have the best doctors and
            nurses to take care of you. We are open 24/7 to take care of you. We
